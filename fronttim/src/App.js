...
import CompShowColegios from './Colegios/mostrarColegios';
import CompCreateColegios from './Colegios/crearColegio';
import CompEditColegios from './Colegios/editarColegio';
    ...
    <div>
      ...
      <BrowserRouter>
        <Routes>
            ...
            <Route path='/ShowColegios' element={ <CompShowColegios />} />
            <Route path='/createCole' element={ <CompCreateColegios />} />
            <Route path='/editCole/:id' element={ <CompEditColegios  />} />
