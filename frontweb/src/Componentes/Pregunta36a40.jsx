...
const CompPreg36a40 = () => {
  ...
  <div className="fuente_init">PREGUNTAS DE LA 36 A LA 40</div>
  ...
  <Grid xs={12} md={12} lg={12} alignItems="center" 
    ...
    <div className="progreso9"></div>
    <div className="font_progresos"> 40 de 40</div>
  ...
  <form className="Form_Preguntas" onSubmit={update}>
        ...
        *  Me gusta mucho participar en donde quiera que puedo: Consejo estudiantil, periódico, grupos sociales.
        ...
        <input type="radio" value="0" name="pregunta40" /> No
            ...
            <form method="get" action="/Pregunta31a35">
