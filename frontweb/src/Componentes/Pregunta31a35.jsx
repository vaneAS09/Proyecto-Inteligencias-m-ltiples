...
const CompPreg31a35 = () => {
  ...
  <div className="fuente_init">PREGUNTAS DE LA 31 A LA 35</div>
  ...
  <Grid xs={12} md={12} lg={12} alignItems="center" 
    ...
    <div className="progreso8"></div>
    <div className="font_progresos"> 35 de 40</div>
  ...
  <form className="Form_Preguntas" onSubmit={update}>
        ...
        * Conozco mis sentimientos y logro controlarlos o expresarlos de manera adecuada.
        ...
        <input type="radio" value="0" name="pregunta35" /> No
            ...
            <form method="get" action="/Pregunta26a30">
